...
function Contact_img({ img, href }) {
  return (
    <div className="flex justify-center px-2 py-2 sm:px-4 sm:py-4">
      <div className="rounded-3xl bg-white dark:bg-gray-900 border border-transparent dark:border-gray-800 p-2 shadow-sm transition duration-300 hover:shadow-lg sm:p-4">
