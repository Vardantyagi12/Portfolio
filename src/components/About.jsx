        ...
        <div className="py-16 bg-white dark:bg-gray-950">
            <div className="container m-auto px-6 text-gray-600 dark:text-gray-300 md:px-12 xl:px-6">
                <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                    ...
                    <div className="md:w-7/12 lg:w-6/12 ml-10 mt-6 md:mt-0 space-y-6 rounded-3xl border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-gray-900 p-6 shadow-2xl">
                ...
                <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row md:gap-6 lg:items-center lg:gap-12 mt-16">
                    ...
                    <div className="md:w-7/12 lg:w-6/12 ml-10 mt-6 md:mt-0">
                        ...
                        <ol className="mt-6 list-decimal list-inside space-y-3 rounded-3xl border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-gray-900 p-6 shadow-2xl">
                            <li className="rounded-2xl border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 px-4 py-3 text-gray-700 dark:text-gray-300 shadow-sm transition hover:border-orange-800 hover:shadow-md marker:text-orange-500 marker:text-lg marker:font-semibold">
                                HTML
                            </li>
                            <li className="rounded-2xl border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 px-4 py-3 text-gray-700 dark:text-gray-300 shadow-sm transition hover:border-orange-800 hover:shadow-md marker:text-orange-500 marker:text-lg marker:font-semibold">
                                CSS
